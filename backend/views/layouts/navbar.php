    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="#" class="dropdown-item">
                    <!-- Message Start -->
                    <div class="media">
                        <img src="<?= Yii::getAlias('@image') ?>/<?= Yii::$app->user->identity->image ?>" alt="User Avatar" class="img-size-50 mr-3 img-circle">
        ...
        <li class="nav-item dropdown user-menu">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                <img src="<?= Yii::getAlias('@image') ?>/<?= Yii::$app->user->identity->image ?>" class="user-image img-circle elevation-2" alt="User Image">
